    ...
    <body>
        ...
        <form action="{{ route('estudiantes.update', $estudiante) }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="carrera" value="{{ $estudiante->carrera }}" autocomplete="off" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">                
            </div>
