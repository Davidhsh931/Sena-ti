...
<head>
  ...
  <title>Ver Nota | Gestor de Notas</title>
  <style>
    :root {
      --bg: #0a0a0f;
...
<body>
  <div class="card">
    ...
    <div class="info">
      ...
      <p><strong>Descripción:</strong> {{ $notas->descripcion }}</p>
    </div>

    <div style="text-align:center;">
      <a href="{{ route('notas.index') }}" class="btn">Volver</a>
    </div>

    <p class="footer">© {{ date('Y') }} Gestor de Notas — Detalle de la nota</p>
  </div>
</body>
</html>
